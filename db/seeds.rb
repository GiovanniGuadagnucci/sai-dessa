...
Question.create(content: "Me sinto muito mal quando erro", category: "self_knowledge", right_answer: 1)
Question.create(content: "Frequentemente me sinto ansioso", category: "self_knowledge", right_answer: 1)
Question.create(content: "Preciso de ajuda de outras pessoas para decidir algo importante na minha vida mesmo que não impacte mais ninguém ", category: "self_knowledge", right_answer: 1)
Question.create(content: "Concordo com o que os demais dizem somente para evitar conflitos", category: "self_knowledge", right_answer: 1)
Question.create(content: "Normalmente desconfio quando recebo um elogio", category: "self_knowledge", right_answer: 1)
...
Question.create(content: "Não penso em meus valores pessoais para tomar uma decisão", category: "personal_values", right_answer: 1)

Question.create(content: "Reconheço ter algumas habilidades que são inúteis para alcançar os meus objetivos pessoais", category: "hard_skills", right_answer: 5)
...
Question.create(content: "Tenho habilidades interpessoais que não se alinham com aquilo que quero", category: "soft_skills", right_answer: 5)
Question.create(content: "Minhas qualidades pessoais são frequentemente elogiadas pelos meus colegas", category: "soft_skills", right_answer: 5)
...
Question.create(content: "Preciso me desenvolver em todos os meus pontos fracos", category: "week_points", right_answer: 1)
...
Question.create(content: "Na maioria das vezes eu não estou pensando em evoluir meus pontos fortes, foco nos pontos fracos", category: "strong_points", right_answer: 1)
...
Question.create(content: "Me comprometo em seguir as dicas para me autoconhecer profundamente", category: "first_phase_oath", right_answer: 5)
Question.create(content: "Entendi o que são Hard e Soft Skills e sou capaz de dizer quais são meus pontos fracos e fortes", category: "second_phase_oath", right_answer: 5)
Question.create(content: "Sou capaz de identificar valores, cultura e caracteristicas de empresas! E sei qual delas me interessam", category: "third_phase_oath", right_answer: 5)
Question.create(content: "Já sei o que preciso desenvolver para atingir meu objetivo", category: "fourth_phase_oath", right_answer: 5)

Question.create(content: "Identifico com facilidade pessoas que estão no cargo que quero ocupar", category: "references", right_answer: 5)
...
Education.create(content_url: "Sai_dessa/Primeira_Fase/C25", category: "self_knowledge")
Education.create(content_url: "Sai_dessa/Primeira_Fase/C26", category: "self_knowledge")
Education.create(content_url: "Sai_dessa/Primeira_Fase/C27", category: "self_knowledge")
Education.create(content_url: "Sai_dessa/Primeira_Fase/C28", category: "personal_objectives")
Education.create(content_url: "Sai_dessa/Primeira_Fase/C29", category: "personal_values")

Education.create(content_url: "Sai_dessa/Segunda_Fase/C85", category: "hard_skills")
Education.create(content_url: "Sai_dessa/Segunda_Fase/C86", category: "soft_skills")
Education.create(content_url: "Sai_dessa/Segunda_Fase/C87", category: "soft_skills")
Education.create(content_url: "Sai_dessa/Segunda_Fase/C88", category: "hard_skills")
Education.create(content_url: "Sai_dessa/Segunda_Fase/C89", category: "strong_points")
Education.create(content_url: "Sai_dessa/Segunda_Fase/C89", category: "week_points")

Education.create(content_url: "Sai_dessa/Terceira_Fase/C116", category: "company_culture")
Education.create(content_url: "Sai_dessa/Terceira_Fase/C117", category: "company_culture")
Education.create(content_url: "Sai_dessa/placeholder", category: "company_values")
Education.create(content_url: "Sai_dessa/placeholder", category: "company_characteristics")
Education.create(content_url: "Sai_dessa/placeholder", category: "positions")

Education.create(content_url: "Sai_dessa/placeholder", category: "references")
Education.create(content_url: "Sai_dessa/placeholder", category: "new_hard_skills")
Education.create(content_url: "Sai_dessa/placeholder", category: "new_soft_skills")

Education.create(content_url: "Sai_dessa/Primeira_Fase/C24", category: "first_phase_intro")
