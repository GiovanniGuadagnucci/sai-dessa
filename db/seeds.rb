...
Education.create(content_url: "Sai_dessa/Segunda_Fase/C90", category: "week_points")

Education.create(content_url: "Sai_dessa/Terceira_Fase/C90", category: "company_culture")
Education.create(content_url: "Sai_dessa/Terceira_Fase/C90", category: "company_culture")
...
Education.create(content_url: "Sai_dessa/Terceira_Fase/C90", category: "third_phase_intro")
